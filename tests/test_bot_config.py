...
async def test_bot_config_crud():
    ...
    async with AsyncClient(transport=transport, base_url="http://test") as ac:
        ...
        await ac.post("/api/v1/auth/register", json={"email": "botuser@example.com", "password": "Str0ngP@ssword!"})
        login_resp = await ac.post("/api/v1/auth/login", json={"email": "botuser@example.com", "password": "Str0ngP@ssword!"})
